...
const readDefinitions: readonly ReadDefinition[] = [
  ...
  ['pollOptions.list', 'active_member', 'List options for a visible poll.'],
  ['pollVotes.list', 'active_member', 'List votes for a visible poll.'],
...
const mutationDefinitions: readonly MutationDefinition[] = [
  ...
  ['activity.create', 'active_member', 'Record an activity entry for the current actor.'],
