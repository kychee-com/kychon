...
export const seed: ProjectSeed = {
  site_config: {
    ...
    brand_text: { value: 'The Eagles', category: 'branding' },
    ...
    theme: {
      value: {
        ...
        interactions: {
          button: {
            hover: { background: '#142a4d', text: '#ffffff' },
          },
          card: {
            hover: { transform: 'translateY(-3px)', shadow: '0 18px 45px rgba(27, 54, 93, 0.16)' },
          },
        },
        header: {
          background: 'color-mix(in srgb, var(--ky-color-bg) 88%, transparent)',
          border_bottom: '1px solid color-mix(in srgb, var(--ky-color-primary) 16%, var(--ky-color-border))',
          shadow: '0 10px 28px rgba(27, 54, 93, 0.08)',
          padding: '0.5rem 0',
          logo_max_height: '2rem',
          brand_text_color: 'var(--ky-color-text)',
        },
        nav: {
          surface_bg: 'color-mix(in srgb, var(--ky-color-primary) 5%, var(--ky-color-bg))',
          surface_padding: '0.25rem',
          surface_radius: '999px',
          link_padding: '0.4rem 0.65rem',
          link_radius: '999px',
          font_size: '0.84rem',
          link_active_bg: 'color-mix(in srgb, var(--ky-color-primary) 14%, var(--ky-color-bg))',
        ...
        footer: {
          background: 'color-mix(in srgb, var(--ky-color-primary) 6%, var(--ky-color-bg))',
  ...
  sections: [
    // --- Header chrome (global) ---
    {
      ...
      config: { href: '/', title: 'The Eagles', short_title: 'The Eagles', subtitle: 'Good Samaritans of Wichita' },
      position: 1,
    },
    {
      page_slug: '*',
    ...
    },
    {
      ...
      config: {
        heading: 'Choose your way to serve',
        columns: 3,
        items: [
          {
            image_url: '/assets/event-food-drive.jpg',
            image_alt: 'Volunteers sorting food donations',
            title: 'Food Security',
            title_position: 'top',
          ...
          },
          {
            ...
            image_alt: 'Eagles volunteers helping frame a home',
          ...
          },
          {
            ...
            image_alt: 'Community garden volunteers harvesting produce',
