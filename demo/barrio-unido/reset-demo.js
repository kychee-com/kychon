...
INSERT INTO site_config (key, value, category) VALUES
  ('theme', '{"primary":"#C2553A","primary_hover":"#A8432D","accent":"#0E7C7B","bg":"#FFF8F0","surface":"#F6E8D8","text":"#2D1810","text_muted":"#7A6B5E","border":"#D4C4B0","success":"#168A5B","warning":"#D99A1E","danger":"#B73535","font_heading":"Merriweather","font_body":"Noto Sans","radius":"0.75rem","max_width":"72rem","interactions":{"button":{"hover":{"background":"#A8432D","text":"#ffffff"}},"card":{"hover":{"transform":"translateY(-3px)","shadow":"0 18px 42px rgba(194, 85, 58, 0.18)"}}},"header":{"background":"color-mix(in srgb, var(--ky-color-bg) 88%, transparent)","border_bottom":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))","shadow":"0 10px 28px rgba(194, 85, 58, 0.08)","padding":"0.9rem 0","logo_max_height":"2.4rem","brand_text_color":"var(--ky-color-text)"},"nav":{"surface_bg":"color-mix(in srgb, var(--ky-color-accent) 8%, var(--ky-color-bg))","surface_padding":"0.25rem","surface_radius":"999px","link_padding":"0.45rem 0.75rem","link_radius":"999px","link_active_bg":"color-mix(in srgb, var(--ky-color-primary) 16%, var(--ky-color-bg))","link_active_color":"var(--ky-color-primary)","link_hover_bg":"color-mix(in srgb, var(--ky-color-accent) 14%, var(--ky-color-bg))","link_hover_color":"var(--ky-color-text)","mobile_menu_bg":"var(--ky-color-bg)"},"footer":{"background":"color-mix(in srgb, var(--ky-color-accent) 8%, var(--ky-color-bg))","border_top":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))"}}', 'theme')
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'nav', '{"items":[{"label":"Inicio","href":"/","icon":"home","public":true},{"label":"Nosotros","href":"/nosotros","icon":"info","public":true},{"label":"Miembros","href":"/directory","icon":"users","auth":true,"feature":"feature_directory"},{"label":"Eventos","href":"/events","icon":"calendar","feature":"feature_events"},{"label":"Recursos","href":"/resources","icon":"book-open","feature":"feature_resources"},{"label":"Foro","href":"/forum","icon":"message-circle","feature":"feature_forum"},{"label":"Encuestas","href":"/polls","icon":"bar-chart","feature":"feature_polls"},{"label":"Programas","href":"/committees","icon":"heart","feature":"feature_committees"},{"label":"Panel","href":"/admin","icon":"bar-chart-2","admin":true},{"label":"Miembros","href":"/admin-members","icon":"users","admin":true},{"label":"Configuración","href":"/admin-settings","icon":"settings","admin":true}]}', 2, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'site_search', '{"placeholder":"Buscar Barrio Unido","submit_label":"Buscar","destination":"/search","compact":true,"default_type":"all"}', 4, true, '1'
