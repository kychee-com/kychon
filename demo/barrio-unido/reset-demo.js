...
INSERT INTO site_config (key, value, category) VALUES
  ...
  ('brand_text', '"Barrio Unido"', 'branding'),
...
INSERT INTO site_config (key, value, category) VALUES
  ('theme', '{"primary":"#C2553A","primary_hover":"#A8432D","accent":"#0E7C7B","bg":"#FFF8F0","surface":"#F6E8D8","text":"#2D1810","text_muted":"#7A6B5E","border":"#D4C4B0","success":"#168A5B","warning":"#D99A1E","danger":"#B73535","font_heading":"Merriweather","font_body":"Noto Sans","radius":"0.75rem","max_width":"72rem","interactions":{"button":{"hover":{"background":"#A8432D","text":"#ffffff"}},"card":{"hover":{"transform":"translateY(-3px)","shadow":"0 18px 42px rgba(194, 85, 58, 0.18)"}}},"header":{"background":"color-mix(in srgb, var(--ky-color-bg) 88%, transparent)","border_bottom":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))","shadow":"0 10px 28px rgba(194, 85, 58, 0.08)","padding":"0.5rem 0","logo_max_height":"2rem","brand_text_color":"var(--ky-color-text)"},"nav":{"surface_bg":"color-mix(in srgb, var(--ky-color-accent) 8%, var(--ky-color-bg))","surface_padding":"0.25rem","surface_radius":"999px","link_padding":"0.4rem 0.65rem","link_radius":"999px","font_size":"0.84rem","link_active_bg":"color-mix(in srgb, var(--ky-color-primary) 16%, var(--ky-color-bg))","link_active_color":"var(--ky-color-primary)","link_hover_bg":"color-mix(in srgb, var(--ky-color-accent) 14%, var(--ky-color-bg))","link_hover_color":"var(--ky-color-text)","mobile_menu_bg":"var(--ky-color-bg)"},"footer":{"background":"color-mix(in srgb, var(--ky-color-accent) 8%, var(--ky-color-bg))","border_top":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))"}}', 'theme')
...
SELECT '*', 'header', 'global', 'brand_header', '{"href":"/","title":"Barrio Unido","short_title":"Barrio Unido","subtitle":"Centro Comunitario"}', 1, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'nav', '{"items":[{"label":"Inicio","href":"/","icon":"home","public":true},{"label":"Nosotros","href":"/nosotros","icon":"info","public":true},{"label":"Eventos","href":"/events","icon":"calendar","feature":"feature_events"},{"label":"Recursos","href":"/resources","icon":"book-open","feature":"feature_resources"},{"label":"Comunidad","icon":"users","children":[{"label":"Miembros","href":"/directory","icon":"users","auth":true,"feature":"feature_directory"},{"label":"Foro","href":"/forum","icon":"message-circle","feature":"feature_forum"},{"label":"Encuestas","href":"/polls","icon":"bar-chart","feature":"feature_polls"},{"label":"Programas","href":"/committees","icon":"heart","feature":"feature_committees"}]},{"label":"Admin","icon":"settings","admin":true,"children":[{"label":"Panel","href":"/admin","icon":"bar-chart-2","admin":true},{"label":"Miembros","href":"/admin-members","icon":"users","admin":true},{"label":"Configuración","href":"/admin-settings","icon":"settings","admin":true}]}]}', 2, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'site_search', '{"placeholder":"Buscar Barrio Unido","submit_label":"Buscar","destination":"/search","compact":true,"mode":"header_icon","default_type":"all"}', 4, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'hero', '{"mode":"foreground","heading":"Bienvenidos a Barrio Unido","subheading":"Tu centro comunitario en el corazón de Boyle Heights. Clases de inglés, clínica legal, despensa de alimentos, eventos culturales y más — todo gratis, todo para ti.","cta_text":"Únete a la comunidad","cta_href":"/nosotros","image_url":"/assets/hero.jpg","image_alt":"Barrio Unido community gathering in Boyle Heights","image_aspect":"21/9","caption_html":"Boyle Heights · <strong>Gratis y con dignidad</strong>","caption_position":"bottom-left","text_position":"over_image"}', 1, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'promo_cards', '{"heading":"Programas que sostienen al barrio","columns":3,"items":[{"image_url":"/assets/event-legal-clinic.jpg","image_alt":"A volunteer legal clinic at Barrio Unido","title":"Clínica Legal","title_position":"top","cta_text":"Ver eventos","cta_href":"/events"},{"image_url":"/assets/event-food-pantry.jpg","image_alt":"Volunteers preparing food pantry bags","title":"Despensa","title_position":"top","cta_text":"Recibir ayuda","cta_href":"/resources"},{"image_url":"/assets/event-mural.jpg","image_alt":"Community members painting a neighborhood mural","title":"Cultura","title_position":"top","cta_text":"Celebrar juntos","cta_href":"/committees"}]}', 5, true, '1'
WHERE NOT EXISTS (SELECT 1 FROM sections WHERE page_slug = 'index' AND zone = 'main' AND scope = 'page' AND section_type = 'promo_cards' AND position = 5);
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'cta', '{"heading":"El barrio te necesita — y tú nos necesitas a nosotros","text":"Ya seas vecino/a nuevo o de toda la vida, hay un lugar para ti en Barrio Unido. Ven a conocernos.","cta_text":"Hazte voluntario/a","cta_href":"/nosotros"}', 10, true, '1'
