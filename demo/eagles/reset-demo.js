...
INSERT INTO site_config (key, value, category) VALUES
  ...
  ('brand_text', '"The Eagles"', 'branding'),
...
INSERT INTO site_config (key, value, category) VALUES
  ('theme', '{"primary":"#1b365d","primary_hover":"#142a4d","accent":"#d99a29","bg":"#fffdf7","surface":"#f7f1e6","text":"#1a1a2e","text_muted":"#6b7280","border":"#d4d0c8","success":"#2f7d4f","warning":"#d99a29","danger":"#b94a3a","font_heading":"Cormorant Garamond","font_body":"Inter","radius":"0.5rem","max_width":"72rem","interactions":{"button":{"hover":{"background":"#142a4d","text":"#ffffff"}},"card":{"hover":{"transform":"translateY(-3px)","shadow":"0 18px 45px rgba(27, 54, 93, 0.16)"}}},"header":{"background":"color-mix(in srgb, var(--ky-color-bg) 88%, transparent)","border_bottom":"1px solid color-mix(in srgb, var(--ky-color-primary) 16%, var(--ky-color-border))","shadow":"0 10px 28px rgba(27, 54, 93, 0.08)","padding":"0.5rem 0","logo_max_height":"2rem","brand_text_color":"var(--ky-color-text)"},"nav":{"surface_bg":"color-mix(in srgb, var(--ky-color-primary) 5%, var(--ky-color-bg))","surface_padding":"0.25rem","surface_radius":"999px","link_padding":"0.4rem 0.65rem","link_radius":"999px","font_size":"0.84rem","link_active_bg":"color-mix(in srgb, var(--ky-color-primary) 14%, var(--ky-color-bg))","link_active_color":"var(--ky-color-primary)","link_hover_bg":"color-mix(in srgb, var(--ky-color-accent) 14%, var(--ky-color-bg))","link_hover_color":"var(--ky-color-text)","mobile_menu_bg":"var(--ky-color-bg)"},"footer":{"background":"color-mix(in srgb, var(--ky-color-primary) 6%, var(--ky-color-bg))","border_top":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))"}}', 'theme')
...
SELECT '*', 'header', 'global', 'brand_header', '{"href":"/","title":"The Eagles","short_title":"The Eagles","subtitle":"Good Samaritans of Wichita"}', 1, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'nav', '{"items":[{"label":"Home","href":"/","icon":"home","public":true},{"label":"About","href":"/about","icon":"info","public":true},{"label":"Volunteer","href":"/volunteer","icon":"heart","public":true},{"label":"Events","href":"/events","icon":"calendar","feature":"feature_events"},{"label":"Resources","href":"/resources","icon":"book-open","feature":"feature_resources"},{"label":"Community","icon":"users","children":[{"label":"Members","href":"/directory","icon":"users","auth":true,"feature":"feature_directory"},{"label":"Forum","href":"/forum","icon":"message-circle","feature":"feature_forum"},{"label":"Polls","href":"/polls","icon":"bar-chart","feature":"feature_polls"},{"label":"Committees","href":"/committees","icon":"briefcase","feature":"feature_committees"}]},{"label":"Admin","icon":"settings","admin":true,"children":[{"label":"Dashboard","href":"/admin","icon":"bar-chart-2","admin":true},{"label":"Members","href":"/admin-members","icon":"users","admin":true},{"label":"Settings","href":"/admin-settings","icon":"settings","admin":true}]}]}', 2, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'site_search', '{"placeholder":"Search The Eagles","submit_label":"Search","destination":"/search","compact":true,"mode":"header_icon","default_type":"all"}', 4, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'hero', '{"mode":"foreground","heading":"Lifting Wichita, One Neighbor at a Time","subheading":"The Eagles are 200+ volunteers dedicated to food drives, habitat builds, youth mentoring, and community outreach across Sedgwick County.","cta_text":"Join The Eagles","cta_href":"/join","image_url":"/assets/hero.jpg","image_alt":"Eagles volunteers gathered at a community service event","image_aspect":"21/9","caption_html":"Founded 1995 · <strong>Sedgwick County, KS</strong>","caption_position":"bottom-right","text_position":"over_image"}', 1, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'promo_cards', '{"heading":"Choose your way to serve","columns":3,"items":[{"image_url":"/assets/event-food-drive.jpg","image_alt":"Volunteers sorting food donations","title":"Food Security","title_position":"top","cta_text":"Pack the next drive","cta_href":"/events"},{"image_url":"/assets/event-habitat-build.jpg","image_alt":"Eagles volunteers helping frame a home","title":"Habitat Builds","title_position":"top","cta_text":"Join a build day","cta_href":"/events"},{"image_url":"/assets/event-garden.jpg","image_alt":"Community garden volunteers harvesting produce","title":"Community Garden","title_position":"top","cta_text":"Grow with us","cta_href":"/volunteer"}]}', 4, true, '1'
WHERE NOT EXISTS (SELECT 1 FROM sections WHERE page_slug = 'index' AND zone = 'main' AND scope = 'page' AND section_type = 'promo_cards' AND position = 4);
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'cta', '{"heading":"Ready to make a difference?","text":"Join The Eagles today and become part of something bigger. Whether you have an hour or a hundred, there is a place for you.","cta_text":"Get Started","cta_href":"/join"}', 5, true, '1'
