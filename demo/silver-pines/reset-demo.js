...
INSERT INTO site_config (key, value, category) VALUES
  ...
  ('brand_text', '"Silver Pines"', 'branding'),
  ...
  ('event_time_display_mode', '"visitor"', 'events')
ON CONFLICT (key) DO NOTHING;

-- site_config (seed-owned: theme updates flow on every deploy)
INSERT INTO site_config (key, value, category) VALUES
  ('theme', '{"primary":"#5B7F5E","primary_hover":"#4A6B4D","accent":"#B88746","bg":"#FFFDF7","surface":"#F4EFE4","text":"#2C2C2C","text_muted":"#5A5A5A","border":"#D5CFC4","success":"#4F8A5B","warning":"#B88746","danger":"#B85C50","font_heading":"Bitter","font_body":"IBM Plex Sans","radius":"0.75rem","max_width":"68rem","interactions":{"button":{"hover":{"background":"#4A6B4D","text":"#ffffff"}},"card":{"hover":{"transform":"translateY(-3px)","shadow":"0 18px 42px rgba(78, 107, 77, 0.18)"}}},"header":{"background":"color-mix(in srgb, var(--ky-color-bg) 90%, transparent)","border_bottom":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))","shadow":"0 10px 28px rgba(74, 107, 77, 0.08)","padding":"0.5rem 0","logo_max_height":"2rem","brand_text_color":"var(--ky-color-text)"},"nav":{"surface_bg":"color-mix(in srgb, var(--ky-color-primary) 7%, var(--ky-color-bg))","surface_padding":"0.25rem","surface_radius":"999px","link_padding":"0.4rem 0.65rem","link_radius":"999px","font_size":"0.84rem","link_active_bg":"color-mix(in srgb, var(--ky-color-primary) 16%, var(--ky-color-bg))","link_active_color":"var(--ky-color-primary)","link_hover_bg":"color-mix(in srgb, var(--ky-color-accent) 14%, var(--ky-color-bg))","link_hover_color":"var(--ky-color-text)","mobile_menu_bg":"var(--ky-color-bg)"},"footer":{"background":"color-mix(in srgb, var(--ky-color-primary) 7%, var(--ky-color-bg))","border_top":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))"}}', 'theme')
...
SELECT '*', 'header', 'global', 'brand_header', '{"href":"/","title":"Silver Pines","short_title":"Silver Pines","subtitle":"Senior Center"}', 1, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'nav', '{"items":[{"label":"Home","href":"/","icon":"home","public":true},{"label":"Daily Schedule","href":"/daily-schedule","icon":"calendar","public":true},{"label":"Getting Here","href":"/getting-here","icon":"map","public":true},{"label":"Events","href":"/events","icon":"calendar","feature":"feature_events"},{"label":"Resources","href":"/resources","icon":"book-open","feature":"feature_resources","children":[{"label":"Transportation","href":"/resources?category=Transportation","public":true},{"label":"Health","href":"/resources?category=Health","public":true},{"label":"Meals","href":"/resources?category=Meals","public":true},{"label":"Technology","href":"/resources?category=Technology","public":true}]},{"label":"Community","icon":"users","children":[{"label":"Our Members","href":"/directory","icon":"users","public":true},{"label":"Forum","href":"/forum","icon":"message-circle","feature":"feature_forum"},{"label":"Polls","href":"/polls","icon":"bar-chart","feature":"feature_polls"},{"label":"Committees","href":"/committees","icon":"briefcase","feature":"feature_committees"},{"label":"Announcements","href":"/#announcements-section","icon":"bell","public":true}]},{"label":"More","icon":"star","children":[{"label":"Block Showcase","href":"/showcase","icon":"star","public":true}]},{"label":"Admin","icon":"settings","admin":true,"children":[{"label":"Dashboard","href":"/admin","icon":"bar-chart-2","admin":true},{"label":"Members","href":"/admin-members","icon":"users","admin":true},{"label":"Settings","href":"/admin-settings","icon":"settings","admin":true}]}]}', 2, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'site_search', '{"placeholder":"Search Silver Pines","submit_label":"Search","destination":"/search","compact":true,"mode":"header_icon","default_type":"all"}', 4, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'getting-here', 'main', 'page', 'custom', '{"html":"<div style=\\"max-width:52rem\\"><p class=\\"mb-8 text-xl text-muted-foreground\\">142 Pine Street, Asheville, NC 28801 &bull; Open Mon-Fri 8am-5pm &bull; <strong>828-555-0100</strong></p><div class=\\"mb-2 overflow-hidden rounded-lg\\"><iframe src=\\"https://maps.google.com/maps?q=142+Pine+Street,+Asheville,+NC+28801&t=&z=15&ie=UTF8&iwloc=&output=embed\\" width=\\"100%\\" height=\\"300\\" style=\\"border:0;display:block\\" loading=\\"lazy\\" referrerpolicy=\\"no-referrer-when-downgrade\\"></iframe></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow\\"><h3 style=\\"margin-bottom:1rem\\">By Car</h3><p>From <strong>I-240</strong>, take Exit 5A (Merrimon Ave). Go south 0.5 miles, turn right on Pine Street. The center is on the left.</p><p><strong>Parking:</strong> Free lot behind the building (enter from Pine Street). 4 accessible parking spaces by the front entrance.</p></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow\\"><h3 style=\\"margin-bottom:1rem\\">Silver Pines Shuttle</h3><p>Our <strong>free shuttle</strong> runs Monday-Friday with 3 routes covering North Asheville, West Asheville, and South Asheville.</p><ul style=\\"margin:1rem 0 1rem 1.5rem\\"><li><strong>Route A (North):</strong> Montford, Merrimon Ave, North Asheville — Departs 8:15am, 10:15am, 1:15pm</li><li><strong>Route B (West):</strong> West Asheville, Candler, Leicester — Departs 8:30am, 10:30am, 1:30pm</li><li><strong>Route C (South):</strong> Biltmore, South Asheville, Arden — Departs 8:00am, 10:00am, 1:00pm</li></ul><p>Return trips depart the center at 12:00pm, 3:00pm, and 5:00pm. Call Frank at <strong>828-555-0106</strong> to arrange a ride or <a href=''/resources''>download the full schedule</a>.</p></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow\\"><h3 style=\\"margin-bottom:1rem\\">Volunteer Driver Program</h3><p>Need a ride to a <strong>medical appointment</strong>? Our volunteer drivers are happy to help. Call the center at <strong>828-555-0100</strong> at least 24 hours in advance. Rides available within 15 miles of Asheville.</p></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow\\"><h3 style=\\"margin-bottom:1rem\\">Public Transit</h3><p><strong>ART Bus Route 170</strong> stops at Pine &amp; Merrimon (2 minute walk). Route runs every 30 minutes weekdays.</p></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow border-l-4 border-l-primary\\"><h3 style=\\"margin-bottom:1rem\\">Accessibility</h3><p>Silver Pines is <strong>fully wheelchair accessible</strong>. We have:</p><ul style=\\"margin:1rem 0 0 1.5rem\\"><li>Ramp at the main entrance</li><li>Wide doorways throughout</li><li>Accessible restrooms on both floors</li><li>Elevator to the second floor</li><li>Hearing loop in the Main Hall</li><li>Large-print materials available</li><li>Service animals welcome</li></ul></div></div>"}', 1, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'showcase', 'main', 'page', 'promo_cards', '{"heading":"Promo cards","columns":3,"items":[{"image_url":"/assets/event-tai-chi.jpg","image_alt":"Members practicing tai chi in the studio","title":"Wellness","title_position":"top","cta_text":"See the schedule","cta_href":"/daily-schedule"},{"image_url":"/assets/event-craft-fair.jpg","image_alt":"Members at the annual craft fair","title":"Events","title_position":"top","cta_text":"View calendar","cta_href":"/events"},{"image_url":"/assets/committee-garden.jpg","image_alt":"Members tending the community garden","title":"Volunteer","title_position":"top","cta_text":"Join a committee","cta_href":"/committees"}]}', 2, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'showcase', 'main', 'page', 'link_list', '{"heading":"Link list — manual, rows","source":"manual","layout":"rows","items":[{"label":"Volunteer driver sign-up","href":"/resources","date":"2026-04-22","badge":"NEW"},{"label":"Spring potluck menu","href":"/resources","date":"2026-04-18"},{"label":"Medicare Basics (PDF)","href":"/assets/medicare-guide.pdf","date":"2026-04-10","badge":"PDF"},{"label":"About this site","href":"https://kychon.com","date":"2026-04-01","external":true}]}', 6, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'hero', '{"mode":"foreground","heading":"Welcome to Silver Pines","subheading":"Asheville''s community center for active adults. Classes, events, friends, and a warm cup of coffee — every day.","cta_text":"See What''s Happening","cta_href":"/events","image_url":"/assets/hero.jpg","image_alt":"Silver Pines members gathered in the main hall","image_aspect":"21/9","caption_html":"Open weekdays · <strong>Asheville, NC</strong>","caption_position":"bottom-right","text_position":"over_image"}', 1, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'stats', '{"items":[{"value":"22+","label":"Active Members","href":"/directory"},{"value":"12+","label":"Events This Month","href":"/events"},{"value":"5","label":"Committees"},{"value":"8","label":"Years Serving Asheville"}]}', 2, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'slideshow', '{"heading":"Scenes from the center","items":[{"src":"/assets/event-tai-chi.jpg","alt":"Members practicing tai chi together","caption":"Morning tai chi","href":""},{"src":"/assets/event-watercolor.jpg","alt":"A watercolor class at Silver Pines","caption":"Watercolor studio","href":""},{"src":"/assets/event-craft-fair.jpg","alt":"Members hosting the craft fair","caption":"Annual craft fair","href":""},{"src":"/assets/event-volunteer.jpg","alt":"Silver Pines volunteers being recognized","caption":"Volunteer appreciation","href":""}],"auto_rotate_seconds":5,"show_arrows":true,"show_dots":true,"aspect_ratio":"16/9","fit":"cover","transition":"fade"}', 5, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'promo_cards', '{"heading":"Find your fit","columns":3,"items":[{"image_url":"/assets/event-tai-chi.jpg","image_alt":"Members practicing tai chi in the studio","title":"Classes & Wellness","title_position":"top","cta_text":"See the schedule","cta_href":"/daily-schedule"},{"image_url":"/assets/event-craft-fair.jpg","image_alt":"Members at the craft fair sharing handmade goods","title":"Events & Activities","title_position":"top","cta_text":"View upcoming events","cta_href":"/events"},{"image_url":"/assets/event-volunteer.jpg","image_alt":"Silver Pines volunteers being recognized","title":"Volunteer & Lead","title_position":"top","cta_text":"Join a committee","cta_href":"/committees"}]}', 7, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT 'index', 'main', 'page', 'cta', '{"heading":"Come Visit Us","text":"Silver Pines is open Monday-Friday, 8am-5pm (6:30pm on Movie Fridays). Drop by for a tour, a cup of coffee, and meet your new neighbors.","cta_text":"How to Get Here","cta_href":"/getting-here"}', 11, true, '1'
...
INSERT INTO sections (page_slug, section_type, config, position, visible) VALUES
  ('getting-here', 'custom', '{
    "html": "<div style=\\"max-width:52rem\\"><p class=\\"mb-8 text-xl text-muted-foreground\\">142 Pine Street, Asheville, NC 28801 &bull; Open Mon-Fri 8am-5pm &bull; <strong>828-555-0100</strong></p><div class=\\"mb-2 overflow-hidden rounded-lg\\"><iframe src=\\"https://maps.google.com/maps?q=142+Pine+Street,+Asheville,+NC+28801&t=&z=15&ie=UTF8&iwloc=&output=embed\\" width=\\"100%\\" height=\\"300\\" style=\\"border:0;display:block\\" loading=\\"lazy\\" referrerpolicy=\\"no-referrer-when-downgrade\\"></iframe></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow\\"><h3 style=\\"margin-bottom:1rem\\">By Car</h3><p>From <strong>I-240</strong>, take Exit 5A (Merrimon Ave). Go south 0.5 miles, turn right on Pine Street. The center is on the left.</p><p><strong>Parking:</strong> Free lot behind the building (enter from Pine Street). 4 accessible parking spaces by the front entrance.</p></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow\\"><h3 style=\\"margin-bottom:1rem\\">Silver Pines Shuttle</h3><p>Our <strong>free shuttle</strong> runs Monday-Friday with 3 routes covering North Asheville, West Asheville, and South Asheville.</p><ul style=\\"margin:1rem 0 1rem 1.5rem\\"><li><strong>Route A (North):</strong> Montford, Merrimon Ave, North Asheville — Departs 8:15am, 10:15am, 1:15pm</li><li><strong>Route B (West):</strong> West Asheville, Candler, Leicester — Departs 8:30am, 10:30am, 1:30pm</li><li><strong>Route C (South):</strong> Biltmore, South Asheville, Arden — Departs 8:00am, 10:00am, 1:00pm</li></ul><p>Return trips depart the center at 12:00pm, 3:00pm, and 5:00pm. Call Frank at <strong>828-555-0106</strong> to arrange a ride or <a href=''/resources.html''>download the full schedule</a>.</p></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow\\"><h3 style=\\"margin-bottom:1rem\\">Volunteer Driver Program</h3><p>Need a ride to a <strong>medical appointment</strong>? Our volunteer drivers are happy to help. Call the center at <strong>828-555-0100</strong> at least 24 hours in advance. Rides available within 15 miles of Asheville.</p></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow\\"><h3 style=\\"margin-bottom:1rem\\">Public Transit</h3><p><strong>ART Bus Route 170</strong> stops at Pine &amp; Merrimon (2 minute walk). Route runs every 30 minutes weekdays.</p></div><div class=\\"mb-2 rounded-lg border border-border bg-card p-8 text-card-foreground shadow border-l-4 border-l-primary\\"><h3 style=\\"margin-bottom:1rem\\">Accessibility</h3><p>Silver Pines is <strong>fully wheelchair accessible</strong>. We have:</p><ul style=\\"margin:1rem 0 0 1.5rem\\"><li>Ramp at the main entrance</li><li>Wide doorways throughout</li><li>Accessible restrooms on both floors</li><li>Elevator to the second floor</li><li>Hearing loop in the Main Hall</li><li>Large-print materials available</li><li>Service animals welcome</li></ul></div></div>"
  }', 1, true),
  ('daily-schedule', 'custom', '{
    "html": "<div style=\\"max-width:60rem\\"><p class=\\"mb-8 text-xl text-muted-foreground\\">Drop in anytime! All classes and activities are free for members unless noted.</p><div class=\\"overflow-x-auto\\"><table><thead><tr><th>Time</th><th>Monday</th><th>Tuesday</th><th>Wednesday</th><th>Thursday</th><th>Friday</th></tr></thead><tbody><tr><td><strong>9:00-10:00</strong></td><td>Chair Yoga</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Tai Chi (George)</td><td>Chair Yoga</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Tai Chi (George)</td><td>Gentle Stretch</td></tr><tr><td><strong>10:00-12:00</strong></td><td>Open Craft Room</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Tech Help Desk</td><td>Open Craft Room</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Tech Help Desk</td><td>Open Craft Room</td></tr><tr><td><strong>11:30-12:30</strong></td><td>Lunch ($3)</td><td>—</td><td>Lunch ($3)</td><td>—</td><td>Lunch ($3)</td></tr><tr><td><strong>1:00-2:00</strong></td><td>Bridge &amp; Cards</td><td>Piano Basics (Mary)</td><td>Bridge &amp; Cards</td><td>Cooking Class (Nancy)</td><td>Bridge &amp; Cards</td></tr><tr><td><strong>2:00-4:00</strong></td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Garden Hours</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Garden Hours</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Watercolor (Margaret)</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Garden Hours</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Garden Hours</td></tr><tr><td><strong>3:00-4:30</strong></td><td>—</td><td>—</td><td>—</td><td>Book Club (Evelyn)</td><td>—</td></tr><tr style=\\"border-top:2px solid var(--color-border)\\"><td><strong>6:30 PM</strong></td><td>—</td><td>—</td><td>—</td><td>—</td><td style=\\"background:color-mix(in srgb, var(--color-primary) 8%, transparent)\\">Movie Night (2nd &amp; 4th Fri)</td></tr></tbody></table></div><div class=\\"mt-2 rounded-lg border border-border border-l-4 border-l-primary bg-card p-6 text-card-foreground shadow\\"><p style=\\"margin:0\\"><strong>Center hours:</strong> Mon-Fri 8am-5pm (6:30pm on Movie Fridays) &bull; <strong>Meal program:</strong> Mon/Wed/Fri 11:30am-12:30pm, $3 suggested donation &bull; <strong>Questions?</strong> Call 828-555-0100</p></div></div>"
  }', 1, true)
ON CONFLICT DO NOTHING;
