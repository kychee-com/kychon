...
INSERT INTO site_config (key, value, category) VALUES
  ('theme', '{"primary":"#5B7F5E","primary_hover":"#4A6B4D","accent":"#B88746","bg":"#FFFDF7","surface":"#F4EFE4","text":"#2C2C2C","text_muted":"#5A5A5A","border":"#D5CFC4","success":"#4F8A5B","warning":"#B88746","danger":"#B85C50","font_heading":"Bitter","font_body":"IBM Plex Sans","radius":"0.75rem","max_width":"68rem","interactions":{"button":{"hover":{"background":"#4A6B4D","text":"#ffffff"}},"card":{"hover":{"transform":"translateY(-3px)","shadow":"0 18px 42px rgba(78, 107, 77, 0.18)"}}},"header":{"background":"color-mix(in srgb, var(--ky-color-bg) 90%, transparent)","border_bottom":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))","shadow":"0 10px 28px rgba(74, 107, 77, 0.08)","padding":"0.95rem 0","logo_max_height":"2.45rem","brand_text_color":"var(--ky-color-text)"},"nav":{"surface_bg":"color-mix(in srgb, var(--ky-color-primary) 7%, var(--ky-color-bg))","surface_padding":"0.25rem","surface_radius":"999px","link_padding":"0.45rem 0.75rem","link_radius":"999px","link_active_bg":"color-mix(in srgb, var(--ky-color-primary) 16%, var(--ky-color-bg))","link_active_color":"var(--ky-color-primary)","link_hover_bg":"color-mix(in srgb, var(--ky-color-accent) 14%, var(--ky-color-bg))","link_hover_color":"var(--ky-color-text)","mobile_menu_bg":"var(--ky-color-bg)"},"footer":{"background":"color-mix(in srgb, var(--ky-color-primary) 7%, var(--ky-color-bg))","border_top":"1px solid color-mix(in srgb, var(--ky-color-primary) 18%, var(--ky-color-border))"}}', 'theme')
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'nav', '{"items":[{"label":"Home","href":"/","icon":"home","public":true},{"label":"Daily Schedule","href":"/daily-schedule","icon":"calendar","public":true},{"label":"Getting Here","href":"/getting-here","icon":"map","public":true},{"label":"Block Showcase","href":"/showcase","icon":"star","public":true},{"label":"Our Members","href":"/directory","icon":"users","public":true},{"label":"Events","href":"/events","icon":"calendar","feature":"feature_events"},{"label":"Resources","href":"/resources","icon":"book-open","feature":"feature_resources","children":[{"label":"Transportation","href":"/resources?category=Transportation","public":true},{"label":"Health","href":"/resources?category=Health","public":true},{"label":"Meals","href":"/resources?category=Meals","public":true},{"label":"Technology","href":"/resources?category=Technology","public":true}]},{"label":"Forum","href":"/forum","icon":"message-circle","feature":"feature_forum"},{"label":"Polls","href":"/polls","icon":"bar-chart","feature":"feature_polls"},{"label":"Committees","href":"/committees","icon":"briefcase","feature":"feature_committees"},{"label":"Announcements","href":"/#announcements-section","icon":"bell","public":true},{"label":"Dashboard","href":"/admin","icon":"bar-chart-2","admin":true},{"label":"Members","href":"/admin-members","icon":"users","admin":true},{"label":"Settings","href":"/admin-settings","icon":"settings","admin":true}]}', 2, true, '1'
...
INSERT INTO sections (page_slug, zone, scope, section_type, config, position, visible, column_span)
SELECT '*', 'header', 'global', 'site_search', '{"placeholder":"Search Silver Pines","submit_label":"Search","destination":"/search","compact":true,"default_type":"all"}', 4, true, '1'
