...
Kychon separates browser-visible static URLs from backing Run402 release asset paths so clean public page routes remain canonical while generated `.html` implementation files stay hidden unless deliberately exposed.
