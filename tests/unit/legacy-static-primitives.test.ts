...
describe('legacy static UI primitives', () => {
  ...
  it('keeps retired primitive CSS out of source', async () => {
    ...
    expect(sanitizeHtml).toContain("import { parseHtmlBody, serializeHtmlChildren } from './dom-fragment'");
