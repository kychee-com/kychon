...
export const defaultConfig = [
  ...
  { key: 'feature_activity_feed', value: true, category: 'features' },
  { key: 'feature_reactions', value: true, category: 'features' },
  { key: 'feature_polls', value: true, category: 'features' },
  ...
  { key: 'polls_member_create', value: false, category: 'features' },
  {
    key: 'nav',
    value: [
...
export const allFeaturesEnabled = defaultConfig.map((c) => (c.key.startsWith('feature_') ? { ...c, value: true } : c));

export const noFeaturesEnabled = defaultConfig.map((c) => (c.key.startsWith('feature_') ? { ...c, value: false } : c));
...
export const featureFlags = [
  ...
  'feature_ai_newsletter',
  'feature_ai_insights',
  'feature_ai_onboarding',
  'feature_ai_event_recaps',
];
